---
title: "Relatório dos dados - Stock Quotes BMF&Bovespa Brasil"
...
* __Data inicial__: Os dados são cortados a partir da implantação do plano real (julho/1995), a série de dados de cada ticker inicia-se a partir da segunda cotação a partir do inicio da série ou a partir de 01/07/1995 (dos dois o menor).
```{r}
